...
.field private mVirtualSimEnabledSlot:I
...
.method private constructor <init>(Landroid/content/Context;[Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    .line 124
    invoke-static {p1}, Lmiui/telephony/VirtualSimUtils;->getVirtualSimSlot(Landroid/content/Context;)I

    move-result v3

    iput v3, p0, Lcom/android/internal/telephony/uicc/UiccController;->mVirtualSimEnabledSlot:I
    ...
    invoke-direct {v2, p0, v3}, Lcom/android/internal/telephony/uicc/UiccController$1;-><init>(Lcom/android/internal/telephony/uicc/UiccController;Landroid/os/Handler;)V

    .line 132
    .local v2, "virtualSimObserver":Landroid/database/ContentObserver;
    invoke-virtual {p1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v3

    const-string v4, "virtual_sim_imsi"

    invoke-static {v4}, Lmiui/provider/ExtraSettings$System;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-interface {v3, p0, v6, v1}, Lcom/android/internal/telephony/CommandsInterface;->registerForIccStatusChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v3, p0, v6, v1}, Lcom/android/internal/telephony/CommandsInterface;->registerForAvailable(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v3, p0, v4, v1}, Lcom/android/internal/telephony/CommandsInterface;->registerForSimRefreshEvent(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method static synthetic access$000(Lcom/android/internal/telephony/uicc/UiccController;Z)V
    .locals 0
    ...
    .prologue
    .line 82
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/uicc/UiccController;->checkVirtualSimState(Z)V

    return-void
.end method

.method private checkVirtualSimState(Z)V
    .locals 6
    .param p1, "needGetCardStatus"    # Z

    .prologue
    const/4 v5, 0x0

    .line 432
    iget v1, p0, Lcom/android/internal/telephony/uicc/UiccController;->mVirtualSimEnabledSlot:I

    .line 433
    .local v1, "oldVirtualSlot":I
    iget-object v2, p0, Lcom/android/internal/telephony/uicc/UiccController;->mContext:Landroid/content/Context;

    invoke-static {v2}, Lmiui/telephony/VirtualSimUtils;->getVirtualSimSlot(Landroid/content/Context;)I

    move-result v2

    iput v2, p0, Lcom/android/internal/telephony/uicc/UiccController;->mVirtualSimEnabledSlot:I

    .line 434
    iget v2, p0, Lcom/android/internal/telephony/uicc/UiccController;->mVirtualSimEnabledSlot:I
    ...
    .line 440
    iget v0, p0, Lcom/android/internal/telephony/uicc/UiccController;->mVirtualSimEnabledSlot:I

    .line 446
    .local v0, "disposeSlot":I
    :goto_1
    ...
    const-string v4, "checkVirtualSimState dispose card"
    ...
    invoke-virtual {p0, v3, v4}, Lcom/android/internal/telephony/uicc/UiccController;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    .line 443
    .end local v0    # "disposeSlot":I
    :cond_2
    move v0, v1

    .restart local v0    # "disposeSlot":I
    goto :goto_1
.end method
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v3}, Lcom/android/internal/telephony/uicc/UiccController;->checkVirtualSimState(Z)V
