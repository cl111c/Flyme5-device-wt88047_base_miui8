...
.method protected constructor <init>()V
    ...
    .line 471
    new-instance v0, Lcom/android/internal/telephony/uicc/UiccCard$5;

    invoke-direct {v0, p0}, Lcom/android/internal/telephony/uicc/UiccCard$5;-><init>(Lcom/android/internal/telephony/uicc/UiccCard;)V
...
.method private broadcastSimHotSwap(Z)V
    .locals 3
    .param p1, "isAdded"    # Z
    ...
    const-string v2, "Broadcasting intent ACTION_SIM_HOT_SWAP  isAdded: "
...
.method private onIccSwap(Z)V
    ...
    .prologue
    .line 312
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/uicc/UiccCard;->onIccSwapMiui(Z)Z
    ...
    .line 321
    const-string v10, "onIccSwap: isHotSwapSupported is true, don\'t prompt for rebooting"
    ...
    .line 324
    :cond_1
    const-string v10, "onIccSwap: isHotSwapSupported is false, prompt for rebooting"
    ...
    invoke-virtual {v10, v9}, Landroid/app/AlertDialog$Builder;->setCustomTitle(Landroid/view/View;)Landroid/app/AlertDialog$Builder;

    move-result-object v10

    const/4 v12, 0x0

    invoke-virtual {v10, v0, v12}, Landroid/app/AlertDialog$Builder;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    invoke-direct {v10, p0, v1, v7}, Lcom/android/internal/telephony/uicc/UiccCard$2;-><init>(Lcom/android/internal/telephony/uicc/UiccCard;Landroid/app/AlertDialog;Ljava/util/Timer;)V
...
.method private onIccSwapMiui(Z)Z
    .locals 13
    .param p1, "isAdded"    # Z
    ...
    sget v11, Lmiui/R$style;->Theme_Light_Dialog_Alert:I

    invoke-direct {v8, v10, v11}, Landroid/app/AlertDialog$Builder;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v8, v7}, Landroid/app/AlertDialog$Builder;->setTitle(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;

    move-result-object v8

    invoke-virtual {v8, v4, v3}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    new-instance v8, Lcom/android/internal/telephony/uicc/UiccCard$4;

    invoke-direct {v8, p0, v1, v6}, Lcom/android/internal/telephony/uicc/UiccCard$4;-><init>(Lcom/android/internal/telephony/uicc/UiccCard;Landroid/app/AlertDialog;Ljava/util/Timer;)V

    const-wide/16 v10, 0x2710

    invoke-virtual {v6, v8, v10, v11}, Ljava/util/Timer;->schedule(Ljava/util/TimerTask;J)V
    ...
    .end local v1    # "dialog":Landroid/app/AlertDialog;
    .end local v3    # "listener":Landroid/content/DialogInterface$OnClickListener;
    .end local v4    # "positiveButtonText":I
    ...
    .line 406
    .restart local v3    # "listener":Landroid/content/DialogInterface$OnClickListener;
    .restart local v4    # "positiveButtonText":I
