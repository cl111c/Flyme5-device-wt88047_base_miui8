...
.method private isVsimFeatureEnabled()Z
    .locals 4
    ...
    invoke-static {v2}, Lcom/android/internal/telephony/dataconnection/DctController;->access$1300(Lcom/android/internal/telephony/dataconnection/DctController;)Landroid/content/Context;
    ...
    const-string v2, "Vsim feature enabled = "
...
.method private removeRequestIfFound(Landroid/net/NetworkRequest;)V
    ...
    invoke-direct {p0}, Lcom/android/internal/telephony/dataconnection/DctController$TelephonyNetworkFactory;->isVsimFeatureEnabled()Z
...
.method public updateNetworkCapability()V
    ...
    const-string v3, "update networkCapabilites for subId = "
    ...
    .line 1172
    iget-object v2, p0, Lcom/android/internal/telephony/dataconnection/DctController$TelephonyNetworkFactory;->mNetworkCapabilities:Landroid/net/NetworkCapabilities;
    ...
    invoke-virtual {v2, v1}, Lcom/android/internal/telephony/SubscriptionController;->getSubState(I)I
    ...
    const-string v3, "INTERNET capability is with subId = "
    ...
    invoke-virtual {v2, v5}, Landroid/net/NetworkCapabilities;->addCapability(I)Landroid/net/NetworkCapabilities;
    ...
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/dataconnection/DctController$TelephonyNetworkFactory;->setScoreFilter(I)V
    ...
    .line 1189
    const-string v2, "Ready to handle network requests"
    ...
    const-string v3, "INTERNET capability is removed from subId = "
    ...
    invoke-virtual {v2, v5}, Landroid/net/NetworkCapabilities;->removeCapability(I)Landroid/net/NetworkCapabilities;
