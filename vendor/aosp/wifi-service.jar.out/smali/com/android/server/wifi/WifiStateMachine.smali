...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/server/wifi/WifiTrafficPoller;)V
    ...
    iput v2, v0, Lcom/android/server/wifi/WifiStateMachine;->mReason:I
...
.method static synthetic access$14202(Lcom/android/server/wifi/WifiStateMachine;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/WifiStateMachine;
    .param p1, "x1"    # I
    ...
    .prologue
    .line 141
    iput p1, p0, Lcom/android/server/wifi/WifiStateMachine;->mReason:I
...
.method static synthetic access$23500(Lcom/android/server/wifi/WifiStateMachine;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiStateMachine;
...
.method static synthetic access$24300(Lcom/android/server/wifi/WifiStateMachine;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/WifiStateMachine;
...
.method private sendConnectedState()V
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachineInjector;->isExplicitlySelected(Landroid/content/Context;)Z
...
.method private setNetworkDetailedState(Landroid/net/NetworkInfo$DetailedState;)Z
    ...
    const-string v5, "setDetailed state send new extra info"
    ...
    invoke-virtual {v4, v5}, Landroid/net/NetworkInfo;->setExtraInfo(Ljava/lang/String;)V
    ...
    iget v1, p0, Lcom/android/server/wifi/WifiStateMachine;->mReason:I
    ...
    invoke-virtual {v4, p1, v1, v5}, Landroid/net/NetworkInfo;->setDetailedState(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;Ljava/lang/String;)V

    .line 4449
    const/4 v1, -0x1

    iput v1, p0, Lcom/android/server/wifi/WifiStateMachine;->mReason:I
...
.method private setScanResults()V
    ...
    .line 3482
    .local v35, "wpsDeviceName":Ljava/lang/String;
    :cond_0
    move-object/from16 v0, p0
    ...
    .line 3533
    .local v37, "wpsDeviceNameStrLength":I
    ...
    .end local v35    # "wpsDeviceName":Ljava/lang/String;
    .local v36, "wpsDeviceName":Ljava/lang/String;
    move-object/from16 v39, v38

    .end local v38    # "wpsState":Ljava/lang/String;
    .local v39, "wpsState":Ljava/lang/String;
    :goto_4
    move/from16 v0, v22
    ...
    .end local v36    # "wpsDeviceName":Ljava/lang/String;
    .restart local v35    # "wpsDeviceName":Ljava/lang/String;
    move-object/from16 v38, v39

    .end local v39    # "wpsState":Ljava/lang/String;
    .restart local v38    # "wpsState":Ljava/lang/String;
    ...
    .end local v35    # "wpsDeviceName":Ljava/lang/String;
    .restart local v36    # "wpsDeviceName":Ljava/lang/String;
    move-object/from16 v39, v38

    .end local v38    # "wpsState":Ljava/lang/String;
    .restart local v39    # "wpsState":Ljava/lang/String;
    goto :goto_4
    ...
    invoke-static/range {v41 .. v41}, Landroid/net/wifi/WifiSsid;->createFromAsciiEncoded(Ljava/lang/String;)Landroid/net/wifi/WifiSsid;
    ...
    .line 3566
    sget-object v41, Lcom/android/server/wifi/WifiStateMachine;->mNotZero:Ljava/util/regex/Pattern;
    ...
    .end local v24    # "len$":I
    .end local v26    # "lines":[Ljava/lang/String;
    .end local v37    # "wpsDeviceNameStrLength":I
    .end local v39    # "wpsState":Ljava/lang/String;
    .end local v40    # "wpsStateStrLength":I
    .restart local v38    # "wpsState":Ljava/lang/String;
    :goto_9
    :try_start_9
    monitor-exit v42
    ...
    .restart local v32    # "ssid":Ljava/lang/String;
    .restart local v36    # "wpsDeviceName":Ljava/lang/String;
    .restart local v37    # "wpsDeviceNameStrLength":I
    .restart local v39    # "wpsState":Ljava/lang/String;
    .restart local v40    # "wpsStateStrLength":I
    :cond_13
    :try_start_a
    move-object/from16 v0, p0
    ...
    iput-object v0, v6, Landroid/net/wifi/ScanResult;->wpsState:Ljava/lang/String;

    .line 3603
    move-object/from16 v0, v36

    iput-object v0, v6, Landroid/net/wifi/ScanResult;->wpsDeviceName:Ljava/lang/String;
    ...
    const-string v43, "setScanResults obtaining null BSSID results <"
    ...
    invoke-virtual/range {v41 .. v41}, Landroid/net/wifi/WifiInfo;->getSupplicantState()Landroid/net/wifi/SupplicantState;
    ...
    sget-object v41, Landroid/net/wifi/SupplicantState;->ASSOCIATING:Landroid/net/wifi/SupplicantState;
    ...
    sget-object v41, Landroid/net/wifi/SupplicantState;->AUTHENTICATING:Landroid/net/wifi/SupplicantState;
    ...
    sget-object v41, Landroid/net/wifi/SupplicantState;->FOUR_WAY_HANDSHAKE:Landroid/net/wifi/SupplicantState;
    ...
    sget-object v41, Landroid/net/wifi/SupplicantState;->GROUP_HANDSHAKE:Landroid/net/wifi/SupplicantState;
    ...
    .line 3655
    :cond_1c
    sget-boolean v41, Lcom/android/server/wifi/WifiStateMachine;->DBG:Z
    ...
    const-string v42, "wifi setScanResults state"
    ...
    const-string v42, " mConnectionRequests="
    ...
    .line 3666
    sget v41, Lcom/android/server/wifi/WifiStateMachine;->MESSAGE_HANDLING_STATUS_PROCESSED:I
    ...
    invoke-virtual/range {v41 .. v41}, Lcom/android/server/wifi/WifiConfigStore;->shouldAutoConnect()Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/wifi/WifiConfigStore;->shouldAutoConnect(Landroid/content/Context;)Z
