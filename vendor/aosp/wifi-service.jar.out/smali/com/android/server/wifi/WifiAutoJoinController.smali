...
.method attemptAutoJoin()Z
    ...
    invoke-virtual/range {v50 .. v50}, Lcom/android/server/wifi/WifiConfigStore;->getWifiAutoConnController()Lcom/android/server/wifi/WifiAutoConnController;

    move-result-object v50

    move-object/from16 v0, v50

    invoke-virtual {v0, v11}, Lcom/android/server/wifi/WifiAutoConnController;->checkAutoConn(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    const-string v51, "attemptAutoJoin skip due to connection Unstable  "
...
.method public attemptRoam(Landroid/net/wifi/ScanResult;Landroid/net/wifi/WifiConfiguration;ILjava/lang/String;)Landroid/net/wifi/ScanResult;
    ...
    invoke-virtual {v14}, Lcom/android/server/wifi/WifiConfigStore;->getWifiAutoConnController()Lcom/android/server/wifi/WifiAutoConnController;

    move-result-object v14

    invoke-virtual {v14, v5}, Lcom/android/server/wifi/WifiAutoConnController;->checkAutoConn(Landroid/net/wifi/ScanResult;)Z
    ...
    .line 1050
    const-string v14, "WifiAutoJoinController "

    new-instance v15, Ljava/lang/StringBuilder;

    invoke-direct {v15}, Ljava/lang/StringBuilder;-><init>()V

    const-string v16, "attemptRoam skip due to in blackList, ssid: "
