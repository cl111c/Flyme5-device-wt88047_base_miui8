...
.field protected static final EVENT_NEED_SET_NETWORK_SELECTION_TYPE:I = 0x65

.field protected static final EVENT_NEED_SET_PREFERRED_NETWORK_TYPE:I = 0x64
...
.field public static isDisableLteDevice:Z
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/CommandsInterface;Landroid/telephony/CellInfo;)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/ServiceStateTracker;->mTelephonyManager:Landroid/telephony/TelephonyManager;

    .line 312
    iget-object v0, p0, Lcom/android/internal/telephony/ServiceStateTracker;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    invoke-virtual {v0, v1, v3}, Landroid/telephony/TelephonyManager;->setDataNetworkTypeForPhone(II)V
...
.method public static getTypeForDisableLte(II)I
    .locals 3
    .param p0, "type"    # I
    .param p1, "defType"    # I
    ...
    .prologue
    .line 1184
    sget-boolean v0, Lcom/android/internal/telephony/ServiceStateTracker;->isDisableLteDevice:Z
    ...
    :cond_0
    invoke-static {}, Lcom/android/internal/telephony/ServiceStateTracker;->isDisableLteImsi()Z
    ...
    const-string v2, "getTypeForDisableLte type="
    ...
    .line 1190
    .end local p1    # "defType":I
    :goto_0
    return p1

    .restart local p1    # "defType":I
    :cond_1
    move p1, p0
...
.method protected notifyDataRegStateRilRadioTechnologyChanged()V
    ...
    .line 364
    iget-object v2, p0, Lcom/android/internal/telephony/ServiceStateTracker;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    invoke-virtual {v2, v3, v1}, Landroid/telephony/TelephonyManager;->setDataNetworkTypeForPhone(II)V
