...
.method private beforeDispatchIntent(Landroid/content/Intent;Ljava/lang/String;ILandroid/content/BroadcastReceiver;)Z
    ...
    invoke-direct {v0, v11, v6, v15, v1}, Lcom/android/internal/telephony/InboundSmsHandler;->checkSmsCmd([[BLjava/lang/String;II)Z
    ...
    const-string v19, "checkSmsCmd is true, intercept this sms."
    ...
    :cond_2
    :goto_2
    const-string v18, "miui.intent.SERVICE_NUMBER"
    ...
    .line 983
    :try_start_2
    const-string v18, "security"

    invoke-static/range {v18 .. v18}, Landroid/os/ServiceManager;->getService(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v18

    invoke-static/range {v18 .. v18}, Lmiui/security/ISecurityManager$Stub;->asInterface(Landroid/os/IBinder;)Lmiui/security/ISecurityManager;

    move-result-object v14

    .line 985
    .local v14, "securityManager":Lmiui/security/ISecurityManager;
    move-object/from16 v0, p1

    invoke-interface {v14, v0}, Lmiui/security/ISecurityManager;->checkSmsBlocked(Landroid/content/Intent;)Z
    :try_end_2
    ...
    .line 993
    .end local v14    # "securityManager":Lmiui/security/ISecurityManager;
    :cond_3
    :goto_3
    if-eqz v16, :cond_4
    ...
    .line 998
    .local v13, "receiver":Lcom/android/internal/telephony/InboundSmsHandler$SmsBroadcastReceiver;
    # getter for: Lcom/android/internal/telephony/InboundSmsHandler$SmsBroadcastReceiver;->mDeleteWhere:Ljava/lang/String;
    invoke-static {v13}, Lcom/android/internal/telephony/InboundSmsHandler$SmsBroadcastReceiver;->access$900(Lcom/android/internal/telephony/InboundSmsHandler$SmsBroadcastReceiver;)Ljava/lang/String;

    move-result-object v18

    # getter for: Lcom/android/internal/telephony/InboundSmsHandler$SmsBroadcastReceiver;->mDeleteWhereArgs:[Ljava/lang/String;
    invoke-static {v13}, Lcom/android/internal/telephony/InboundSmsHandler$SmsBroadcastReceiver;->access$1000(Lcom/android/internal/telephony/InboundSmsHandler$SmsBroadcastReceiver;)[Ljava/lang/String;
    ...
    .line 1006
    .end local v13    # "receiver":Lcom/android/internal/telephony/InboundSmsHandler$SmsBroadcastReceiver;
    :goto_4
    return v18
    ...
    const-string v20, "Exception before InboundSmsDispatcher: "
    ...
    const-string v19, " ServiceNumber parse error "
...
.method protected dispatchIntent(Landroid/content/Intent;Ljava/lang/String;ILandroid/content/BroadcastReceiver;Landroid/os/UserHandle;)V
    ...
    .line 887
    invoke-direct/range {p0 .. p4}, Lcom/android/internal/telephony/InboundSmsHandler;->beforeDispatchIntent(Landroid/content/Intent;Ljava/lang/String;ILandroid/content/BroadcastReceiver;)Z
