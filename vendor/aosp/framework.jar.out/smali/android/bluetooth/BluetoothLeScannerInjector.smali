...
.method public static startLeScan(ILandroid/bluetooth/le/ScanSettings;Ljava/util/List;Ljava/util/List;Landroid/os/IBinder;)V
    .locals 6
    .param p0, "clientIf"    # I
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Landroid/bluetooth/BleScanWrapper;-><init>(ILandroid/bluetooth/le/ScanSettings;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {v1, v5, p4}, Landroid/os/Bundle;->putBinder(Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    invoke-static {v5}, Lcom/miui/whetstone/server/IWhetstoneActivityManager$Stub;->asInterface(Landroid/os/IBinder;)Lcom/miui/whetstone/server/IWhetstoneActivityManager;

    move-result-object v4

    .line 61
    .local v4, "ws":Lcom/miui/whetstone/server/IWhetstoneActivityManager;
    if-eqz v4, :cond_0

    .line 62
    invoke-interface {v4}, Lcom/miui/whetstone/server/IWhetstoneActivityManager;->getPowerKeeperPolicy()Lcom/miui/whetstone/IPowerKeeperPolicy;

    move-result-object v5

    invoke-interface {v5, v1}, Lcom/miui/whetstone/IPowerKeeperPolicy;->startLeScan(Landroid/os/Bundle;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v3    # "uid":I
    .end local v4    # "ws":Lcom/miui/whetstone/server/IWhetstoneActivityManager;
    :cond_0
    :goto_0
    return-void
...
.method public static stopLeScan(ILandroid/os/IBinder;)V
    ...
    invoke-direct {v0, p0, v5, v6, v7}, Landroid/bluetooth/BleScanWrapper;-><init>(ILandroid/bluetooth/le/ScanSettings;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {v1, v5, p1}, Landroid/os/Bundle;->putBinder(Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    invoke-interface {v5, v1}, Lcom/miui/whetstone/IPowerKeeperPolicy;->stopLeScan(Landroid/os/Bundle;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
